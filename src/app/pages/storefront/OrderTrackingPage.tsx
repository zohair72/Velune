      ...
      <div className="mx-auto max-w-5xl rounded-[2rem] border border-[#2A2624] bg-[#121110] p-10">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          <div>
            ...
            <h1 className="mt-4 font-cinzel text-4xl">Track your Velune order</h1>
            <p className="mt-6 font-lora leading-8 text-[#A39E98]">
              Enter the order number and phone number you used at checkout to
              review the latest payment and delivery progress for your blend.
            </p>
